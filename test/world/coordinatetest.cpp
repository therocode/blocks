...
TEST_CASE("voxelToRegionVoxel", "[coord]")
{
    ...
    REQUIRE(voxelToRegionVoxel(VoxelCoord(1, 0, 1)) == RegionVoxelCoord(1, 1));
    REQUIRE(voxelToRegionVoxel(VoxelCoord(-1, 0, -1)) == RegionVoxelCoord(511, 511));

    REQUIRE(voxelToRegionVoxel(VoxelCoord(510, 0, 510)) == RegionVoxelCoord(510, 510));
    REQUIRE(voxelToRegionVoxel(VoxelCoord(511, 0, 511)) == RegionVoxelCoord(511, 511));
    REQUIRE(voxelToRegionVoxel(VoxelCoord(512, 0, 512)) == RegionVoxelCoord(0, 0));
    REQUIRE(voxelToRegionVoxel(VoxelCoord(513, 0, 513)) == RegionVoxelCoord(1, 1));

    REQUIRE(voxelToRegionVoxel(VoxelCoord(-510, 0, -510)) == RegionVoxelCoord(2, 2));
    REQUIRE(voxelToRegionVoxel(VoxelCoord(-511, 0, -511)) == RegionVoxelCoord(1, 1));
    REQUIRE(voxelToRegionVoxel(VoxelCoord(-512, 0, -512)) == RegionVoxelCoord(0, 0));
    REQUIRE(voxelToRegionVoxel(VoxelCoord(-513, 0, -513)) == RegionVoxelCoord(511, 511));
}
