...
using ChunkDeletedPackage       = Package<ChunkDeleted_tag,         PackageType::CHUNK_DELETED,         false, CHANNEL_CHUNKS, ChunkCoord>;
...
using GfxEntityMovedPackage     = Package<MoveGfxEntity_tag,        PackageType::GFX_ENTITY_MOVED,      true, CHANNEL_ENTITY, size_t, glm::vec3>;

struct RotateGfxEntity_tag{};
using GfxEntityRotatedPackage   = Package<RotateGfxEntity_tag,      PackageType::GFX_ENTITY_ROTATED,    true, CHANNEL_ENTITY, size_t, float, float>;
...
using PlayerPitchYawPackage     = Package<PlayerPitchYaw_tag,         PackageType::PLAYER_PITCH_YAW,      true , CHANNEL_ENTITY, size_t, float, float>;
